...
@section('title')
    <title>Thêm mới công nghệ & sản phẩm</title>
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Thêm mới công nghệ & sản phẩm</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Admin</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.product.index') }}">Quản lý công nghệ & sản phẩm</a></li>
                        <li class="breadcrumb-item active">Thêm mới công nghệ & sản phẩm</li>
                    </ol>
                </div>
