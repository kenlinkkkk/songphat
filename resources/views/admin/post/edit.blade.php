...
@section('title')
    <title>Sửa tin tức & sự kiện</title>
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Sửa tin tức & sự kiện</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Admin</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.post.index') }}">Quản lý tin tức & sự  kiện</a></li>
                        <li class="breadcrumb-item active">Sửa tin tức & sự kiện</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Sửa tin tức & sự kiện</h4>
                    ...
                    <form method="post" action="{{ route('admin.post.update', ['id' => $post->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Slug</label>
                            <input type="text" class="form-control" name="slug" disabled value="{{ $post->slug }}">
                        </div>
                        <div class="row">
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label>Ngày hiển thị</label>
                                    <input type="date" class="form-control" name="date" required value="{{ $post->date }}">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type_id" required>
                                        ...
                                        @foreach($postType as $item)
                                            <option value="{{ $item->id }}" {{ $item->id == $post->type_id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label>Mô tả</label>
                            <textarea class="form-control" rows="7" name="short_description">{{ $post->short_description }}</textarea>
                        </div>
