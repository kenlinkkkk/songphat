    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Thêm mới vị trí tuyển dụng</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Admin</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.position.index') }}">Quản lý vị trí tuyển dụng</a></li>
                        <li class="breadcrumb-item active">Thêm mới vị trí tuyển dụng</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.position.create') }}" enctype="multipart/form-data">
                        @csrf
