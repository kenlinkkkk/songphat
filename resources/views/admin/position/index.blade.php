...
@section('title')
    <title>Vị trí tuyển dụng</title>
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Vị trí tuyển dụng</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Admin</a></li>
                        <li class="breadcrumb-item active">Vị trí tuyển dụng</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body table-responsive">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-sm btn-success mb-2" href="{{ route('admin.position.add') }}">Thêm mới</a>
                    </div>
                    <table class="table table-hover">
                        ...
                        @foreach($positions as $item)
                            <tr>
                                ...
                                @if ($item->status == 1)
                                    ...
                                    <td class="text-right">
                                        <form id="form-{{ $item->id }}" method="post" action="{{ route('admin.position.update', [$item->id]) }}">
                                            @csrf
                                            <input type="hidden" name="status" value="0">
                                            <a href="{{ route('admin.position.edit', [$item->id]) }}" class="btn btn-success btn-sm">Sửa</a>
                        ...
                        @endforeach
                        <tr>
                            <td colspan="5">{{ $positions->links() }}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
